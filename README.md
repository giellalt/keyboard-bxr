.. -*- mode: rst -*-
==========================================
 Keyboards for the Russia Buriat language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Russia Buriat language. The data and implementations
...
* http://giellatekno.uit.no/bxrdoc/index.html
* https://giellalt.uit.no/tools/docu-bxr-manual.html
...
The Russia Buriat keyboard sources can be acquired using the `Giella SVN
